 ...
 */
public class EnvironmentActivator implements ServiceActivator {
	@Override
	public void activate(ServiceActivatorContext ctx) throws ServiceRegistryException {
		...
		factory.createSingletonServiceBuilder(EnvironmentService.NAME, service).build(ctx.getServiceTarget())
