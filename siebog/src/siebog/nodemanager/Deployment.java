...
import siebog.nodemanager.Global;
...
public class Deployment {
	...
	public static Status deploy(InetAddress host, File file, String name) throws DeploymentExecutionException,
		...
		DomainDeployment deployment = new DomainDeployment(client, domain, file, name, Type.FORCE_DEPLOY, null,
				MatchPatternStrategy.FIRST);
