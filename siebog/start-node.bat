...
"%JAVA_EXE%" -server -Dxjaf.base.dir=%CD% -cp .;^
...
%JBOSS_MODULES_BASE%\org\jboss\as\naming\main\wildfly-naming-9.0.0.Alpha1-SNAPSHOT.jar;^
...
%CD%\siebog.war siebog.server.StartNode %*
